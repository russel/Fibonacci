...
main = do
 ...
 runTestTT (testPositive Fibonacci.lazyList_recursion "Lazy List Recursion")
 runTestTT (testNegative Fibonacci.lazyList_recursion "Lazy List Recursion")
 runTestTT (testPositive Fibonacci.lazyList_zipWith "Lazy List ZipWith")
 runTestTT (testNegative Fibonacci.lazyList_zipWith "Lazy List ZipWith")
